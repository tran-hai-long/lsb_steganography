...
class EncodeForm(FlaskForm):
    message = StringField("Message", validators=[DataRequired("Message required.")])
    image = FileField("Image", validators=[FileRequired("Image required."), FileAllowed(["png"], "PNG image required.")])
